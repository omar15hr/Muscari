...
import { countries_body_kids } from "@/utils/products/shortSleeve/kid/BodySizesCmKids";
import { countries_inches_body_kids } from "@/utils/products/shortSleeve/kid/BodySizesInKids";

const columnas = ["Talla", "Tipo de talla", "Altura", "Pecho"];
