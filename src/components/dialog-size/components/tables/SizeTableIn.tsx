...
const columnas = ["Talla", "Tipo de talla", "Hombro", "Largo", "Largo de la manga", "Pecho", "Contorno de bíceps"];


export function SizeTableIn({ countrySizes }: any) {
                    ...
                    countrySizes === 'US'
                      ...
                      (US_inches.map((columna) => (
                        <tr className="text-xs font-medium text-black text-center border hover:bg-gray-200">
                          ...
                          <td className="hover:bg-gray-400">{columna.contorno_bíceps}</td>
                        </tr>
                      )))
