...
import { Instructions } from './Intructions'; // Asegúrate de ajustar la importación al archivo correcto

describe('getTextFromInstructions', () => {
  it('devuelve el array de texto correctamente para instrucciones del cuerpo', () => {
    ...
    const { getByText } = render(<Instructions typeItem="body" />);
  ...
  it('devuelve el array de texto correctamente para instrucciones del producto', () => {
    ...
    const { getByText } = render(<Instructions typeItem="product" />);
