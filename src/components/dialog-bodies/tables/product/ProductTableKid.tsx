...
import { countries_products_kids } from "@/utils/products/bodies/ProductSizesCmKids";
import { countries_inches_products_kids } from "@/utils/products/bodies/ProductSizesInKids";

const columnas = ["Talla", "Largo", "Largo de manga", "Pecho"];
