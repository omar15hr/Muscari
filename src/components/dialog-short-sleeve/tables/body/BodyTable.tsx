...
import { countries_body, countries_inches_body } from "@/utils/products/shortSleeveTee";

const columnas = ["Talla", "Tipo de talla", "Altura", "Pecho", "Contorno cintura", "Contorno caderas"];


export function BodyTable({ countrySizes, unitsMeasurement }: any) {
                  ...
                  : countrySizes === 'UK'
                    ...
                    : countrySizes === 'IT'
                      ...
                      : countrySizes === 'MX'
                        ? countries_body[9].MX
                        : countrySizes === 'FR'
                          ? countries_body[10].FR
                          : ''
  );

  const sizes_inches = (
    countrySizes === 'US'
      ? countries_inches_body[0].US_inches
      : countrySizes === 'BR'
        ? countries_inches_body[1].BR_inches
        : countrySizes === 'EU'
          ? countries_inches_body[2].EU_inches
          : countrySizes === 'DE'
            ? countries_inches_body[3].DE_inches
            : countrySizes === 'SG'
              ? countries_inches_body[4].SG_inches
              : countrySizes === 'AU'
                ? countries_inches_body[5].AU_inches
                : countrySizes === 'JP'
                  ? countries_inches_body[6].JP_inches
                  : countrySizes === 'UK'
                    ? countries_inches_body[7].UK_inches
                    : countrySizes === 'IT'
                      ? countries_inches_body[8].IT_inches
                      : countrySizes === 'MX'
                        ? countries_inches_body[9].MX_inches
                        : countrySizes === 'FR'
                          ? countries_inches_body[10].FR_inches
                          : ''
  );
          ...
          <thead className="bg-white border-b rounded">
            <tr>
              {columnas.map((columna) => (
                <th scope="col" className="bg-blue-gray-50 text-sm text-black px-6 py-2 text-center border-blue-gray-100">
                  {columna}
                </th>
              ))}
            </tr>
